...
export default function Minicompsecond({toggle2}) {
  return (
    ...
    <li className='popular-artists'>Popular Albums</li>
            ...
            <div className="singers">
              ...
              <li className="singer-box">
                <div className="image">
                  ...
                  <span className="artist">Ankit Tiwari </span>
                </div>
                <div class="middle">
                  <div class="text">
                    <svg
              ...
              <li className="singer-box">
                <div className="image">
                  ...
                  <span className="artist"> Arijit Singh</span>
                </div>
                <div class="middle">
                  <div class="text">
                    <svg
              ...
              <li className="singer-box">
                <div className="image">
                  ...
                  <span className="artist">Shubh</span>
                </div>
                <div class="middle">
                  <div class="text">
                    <svg
              ...
              <li className="singer-box">
                <div className="image">
                  ...
                  <span className="artist">Puneet Sharma..</span>
                </div>
                <div class="middle">
                  <div class="text">
                    <svg
              ...
              <li className="singer-box">
                <div className="image">
                  ...
                  <span className="artist">AR Rahman,Irsh..</span>
                </div>
                <div class="middle">
                  <div class="text">
                    <svg
              ...
              <li className="singer-box">
                <div className="image">
                  ...
                  <span className="name">Brahmastra</span>
              ...
              <li className="singer-box">
                <div className="image">
                  ...
                  <span className="artist">Ankit Tivari</span>
                </div>
                <div class="middle">
                  <div class="text">
                    <svg
              ...
              <li className="singer-box">
                <div className="image">
                  <img className="albums" src="src/images/album10.webp" alt="" />
                  <br />
              ...
              <li className="singer-box">
                <div className="image">
                  ...
                  <span className="artist">Amitabh Bhattacharya</span>
                </div>
                <div class="middle">
                  <div class="text">
                    <svg
              ...
              <li className="singer-box">
                <div className="image">
                  ...
                  <span className="artist">Baadshah</span>
                </div>
                <div class="middle">
                  <div class="text">
                    <svg
