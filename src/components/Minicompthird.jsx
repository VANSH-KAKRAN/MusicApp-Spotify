    ...
    <div>
      <div>
        <div className="popular-show">
          ...
          <button onClick={toggle3} className="showall">
            Show all
          </button>
        </div>
        <div className="singers">
          <li className="singer-box">
            <div className="image">
              ...
              <span className="artist">With Neha kakkar and Pritam.</span>
            </div>
            <div class="middle">
              <div class="text">
                <svg
          ...
          <li className="singer-box">
            <div className="image">
              ...
              <span className="artist">With Guru randhava & Pritam </span>
            </div>
            <div class="middle">
              <div class="text">
                <svg
          ...
          <li className="singer-box">
            <div className="image">
              ...
              <span className="artist">With Neha Kakkar & AR Rahman</span>
            </div>
            <div class="middle">
              <div class="text">
                <svg
          ...
          <li className="singer-box">
            <div className="image">
              ...
              <span className="artist">With Jassi gill & AR Rahman </span>
            </div>
            <div class="middle">
              <div class="text">
                <svg
          ...
          <li className="singer-box">
            <div className="image">
              ...
              <span className="artist">With AR Rahman & Neha Kakkar</span>
            </div>
            <div class="middle">
              <div class="text">
                <svg
          ...
          <li className="singer-box">
            <div className="image">
              ...
              <span className="artist">Siddhu Mussa Aala</span>
            </div>
            <div class="middle">
              <div class="text">
                <svg
